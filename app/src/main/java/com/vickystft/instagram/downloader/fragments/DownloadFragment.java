package com.vickystft.instagram.downloader.fragments;
...
import com.vickystft.instagram.downloader.activities.MainActivity;
import com.vickystft.instagram.downloader.activities.PreviewActivity;
import com.vickystft.instagram.downloader.adapters.FileAdapter;
import com.vickystft.instagram.downloader.listener.FileClickInterface;
...
public class DownloadFragment extends Fragment implements FileClickInterface {
    ...
    public void getPosition(int position, File file) {
        ...
        inNext.putExtra("VideoDataFile", fileArrayList);
